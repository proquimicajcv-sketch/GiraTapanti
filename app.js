    ...
    <article class="species-card" data-species-id="${escapeHtml(species.id)}">
      <div class="card-top">
        ...
        <div class="card-heading">
          <div>
            ...
            <h2 class="scientific-name"><em>${escapeHtml(species.sciName)}</em></h2>
            <p class="common-name">${escapeHtml(species.commonName)}</p>
          </div>
      ...
      <section class="image-panel">
        <div class="image-frame">
          <span class="image-tag">Registro visual</span>
          <span class="image-side image-side-left">Imagen de referencia</span>
          <span class="image-side image-side-right">Vista de campo</span>
      ...
      <section class="card-body">
        ...
        <div class="record-strip">
          <span>Sección de registro visual de campo</span>
          <span>${hasOpenImage ? "Imagen lista para verificación" : "Completa la URL para habilitar vista externa"}</span>
        </div>
      </section>
    </article>
  `;
